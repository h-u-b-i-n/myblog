...
import com.hubin.dao.CommentRepository;
...
public class CommentServiceImpl implements CommentService {
    ...
    public List<Comment> listCommentByBlogId(Long blogId) {
        ...
        return eachComment(comments);   //comments是所有的一级评论    调用eachComment来循环他
    }

    @Transactional
    @Override
    public Comment saveComment(Comment comment) {
        Long parentCommentId = comment.getParentComment().getId();  //前端给了初始值-1
